...
const numSparks = 45;
// Added bright red (#FF0000, #FF1493) and bright neon purple (#B400FF, #E0B0FF) to the mix
const colorsStart = ['#FFFFFF', '#FFE600', '#FF8C00', '#FF0000', '#FF1493', '#E0B0FF']; 
// End colors cool down to deep reds and dark purples/violets
const colorsEnd = ['#FF4500', '#FF0000', '#8B0000', '#8A2BE2', '#4B0082', '#C71585']; 

let shadows0 = [];
let shadows1 = [];

let seed = 33333; // deterministic seed
function rand() {
...
console.log("Updated sparks to include red and purple");
